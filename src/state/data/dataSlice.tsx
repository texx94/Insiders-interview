      ...
      for (const athlete in athletesData) {
        ...
        if (athleteHistoryIndex == -1) {
          ...
          state.history.push({
            ...
            speedHistory: [athletesData[athlete as keyof object]['speed']],
          })
        } else {
          ...
          const maxSpeed = Math.max(...state.history[athleteHistoryIndex].speedHistory, athletesData[athlete as keyof object]['speed']);
          const minSpeed = Math.min(...state.history[athleteHistoryIndex].speedHistory, athletesData[athlete as keyof object]['speed']);
          const speedHistory = [...state.history[athleteHistoryIndex].speedHistory, athletesData[athlete as keyof object]['speed']]
